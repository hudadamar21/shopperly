<template>
  <nav class="h-20 bg-white flex items-center justify-evenly text-gray-700 rounded-b-3xl shadow mb-10 px-6 md:px-10">
    <h1 class="brand hidden md:block text-3xl md:text-5xl pr-5 text-shopperly-green-400">Shopperly</h1>
    ...
    <div class="flex items-center pl-5 h-full">
      <ul class="menu">
        <li class="relative">
          ...
          <!-- keranjang count -->
          <div class="absolute top-0 right-0 h-3 md:h-4 w-3 md:w-4 rounded-full bg-red-500 text-[8px] md:text-[10px] grid place-items-center text-white">3</div>
      ...
      <ul class="menu" >
        <li>
          <!-- icon toko -->
          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
        ...
        <li class="!w-auto !rounded-md" :class="!isAuthenticate ? 'px-1 md:px-2' : ''">
          <!-- icon user -->
